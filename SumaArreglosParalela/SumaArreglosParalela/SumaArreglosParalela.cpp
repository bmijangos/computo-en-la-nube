...
int main()
{
    std::cout << "Sumando Arreglos en Parallelo!\n";
    float a[N], b[N], c[N];
    int i;
...
#pragma omp parallel for \
    ...
    imprimeArreglo(a);
    std::cout << "Imprimiento los primeros " << mostrar << " valores del arreglo b: " << std::endl;
    imprimeArreglo(b);
    std::cout << "Imprimiento los primeros " << mostrar << " valores del arreglo c: " << std::endl;
    imprimeArreglo(c);
